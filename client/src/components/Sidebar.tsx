...
const sidebarItems: SidebarItem[] = [
  { name: "Panel Principal", icon: "dashboard-line", href: "/" },
  { name: "Colecciones", icon: "database-2-line", href: "/mongodb/collections", section: "MongoDB" },
  { name: "Consultas", icon: "code-line", href: "/mongodb/queries", section: "MongoDB" },
  { name: "Agregaciones", icon: "bar-chart-2-line", href: "/mongodb/aggregations", section: "MongoDB" },
  { name: "Grafos", icon: "share-circle-line", href: "/neo4j/graphs", section: "Neo4j" },
  { name: "Relaciones", icon: "git-branch-line", href: "/neo4j/relationships", section: "Neo4j" },
  { name: "Cypher", icon: "terminal-line", href: "/neo4j/cypher", section: "Neo4j" },
  { name: "Puente de Datos", icon: "link", href: "/integration/data-bridge", section: "Integración" },
  { name: "Historial de Sync", icon: "history-line", href: "/integration/sync-history", section: "Integración" },
];
    ...
    <div className={cn("relative", sidebarOpen ? "w-64" : "w-16")}>
      <div className={cn("h-full flex flex-col bg-neutral-dark text-white transition-all duration-300 ease-in-out", sidebarOpen ? "w-64" : "w-16")}>
        ...
        <div className="flex items-center h-16 px-4 border-b border-white/10">
          ...
          {sidebarOpen && <span className="ml-2 font-bold text-xl">NoSQL Centro</span>}
        </div>
